...
public class DateUtil {
     ...
     * @return
     */
    public static boolean dateCompare(final Date beginDate, final Date endDate) {
        // endDate > beginDate
     ...
     * @return
     */
    public static boolean timeCompare(final Date beginDate, final Date endDate) {
    ...
    public static Long getCurrentExpireTimes() {
        ...
        final Date endTime = instance.getTime();
        // 当前时间与截止时间间隔，单位：秒
        final long interval = (endTime.getTime() - new Date().getTime()) / 1000;
